...
const Home = () => {
    ...
    return <div className="container padding-sides-m">
        ...
        <div className="card-5 container-2col center mobile-width-100 round" style={{maxWidth: "80em"}}>
            ...
            <div className="container no-mobile-padding padding-l right" style={{width: "100%"}} id="teamsmiley-container-2">
                ...
                <a href="https://teamsmiley.org" rel="noopener noreferrer" target="_blank" className="center"><button style={{margin: "1em", fontSize: "1em"}} className="btn-b1" >Visit Site <BiLinkExternal style={{transform: "translateY(0.1em)"}} /></button></a>
            </div>
        </div>
        <h1 className="heading">Featured Blog Articles</h1>
        {state.posts.length>0?
        <div className="container container-2col">
            <div className="card-i1 featured-article right" style={{maxWidth: "30em"}}>
            ...
            <div className="card-i1 featured-article left" style={{maxWidth: "30em"}}>
